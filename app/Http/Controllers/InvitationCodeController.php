...
class InvitationCodeController extends Controller
{
    ...
    public function index(): View
    {
        ...
        $view = Auth::user()->isAdmin() ? 'admin.invitation-codes.index' : 'invitation-codes.index';
        
        return view($view, compact('invitationCodes'));
    }
    ...
    {
        $view = Auth::user()->isAdmin() ? 'admin.invitation-codes.create' : 'invitation-codes.create';
        return view($view);
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route(Auth::user()->isAdmin() ? 'admin.invitation-codes.index' : 'invitation-codes.index')
    ...
    {
        // Check authorization
        if (!Auth::user()->isAdmin() && $invitationCode->user_id !== Auth::id()) {
            abort(403);
        }
