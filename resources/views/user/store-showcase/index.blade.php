                        ...
                        <div class="group relative rounded-2xl p-4 bg-[#181d23] border border-white/5 hover:border-fuchsia-500/60 transition flex flex-col overflow-hidden">
                            ...
                            <div class="relative flex-1">
                                ...
                                <div class="flex items-center gap-1">
                                    ...
                                    <form action="{{ route('user.showcases.destroy', $showcase) }}" method="POST" class="flex-1" onsubmit="return confirm('Hapus produk dari etalase?')">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="w-full py-2 px-2 rounded-lg text-xs font-medium text-red-400 bg-red-500/10 hover:bg-red-500/20 border border-red-500/20 hover:border-red-500/30 transition">
                                            Hapus
                                        </button>
                                    </form>
                                </div>
