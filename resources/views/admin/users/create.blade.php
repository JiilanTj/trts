    ...
    <div class="max-w-xl mx-auto bg-white rounded-lg shadow-sm border border-gray-200">
        ...
        <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data" class="px-6 py-6 space-y-5">
            ...
            <div>
                ...
                <input type="text" name="username" value="{{ old('username') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="level" value="{{ old('level',1) }}" min="1" max="10" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
