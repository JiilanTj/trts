<x-admin-layout>
    ...
    <div class="bg-white rounded-lg shadow-md border border-gray-200">
        <div class="p-6 border-b border-gray-200">
            <div class="flex justify-between items-center">
                ...
                <a href="{{ route('admin.products.index') }}" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg transition duration-200 text-sm">
                    Kembali ke Produk
                </a>
            </div>
        </div>
        ...
        <div class="p-6">
            ...
            <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8" id="product-form">
                @csrf
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="space-y-3">
                            <div>
                                ...
                                <input name="name" value="{{ old('name') }}" required class="w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500" />
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">SKU</label>
                                <input name="sku" value="{{ old('sku') }}" required class="w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500" />
                            </div>
                            <div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                            ...
                            <div>
                                ...
                                <input type="number" min="0" name="stock" value="{{ old('stock',0) }}" class="w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500" />
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Berat (gram)</label>
                                <input type="number" min="0" name="weight" value="{{ old('weight') }}" class="w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500" />
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Tanggal Kadaluarsa</label>
                                <input type="date" name="expiry_date" value="{{ old('expiry_date') }}" class="w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500" />
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Harga Beli</label>
                                <input type="number" min="0" name="purchase_price" id="purchase_price" value="{{ old('purchase_price') }}" class="price-field w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500" />
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Harga Jual (External)</label>
                                <input type="number" min="0" name="sell_price" id="sell_price" value="{{ old('sell_price') }}" class="price-field w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500" />
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Promo Price (Opsional)</label>
                                <input type="number" min="0" name="promo_price" id="promo_price" value="{{ old('promo_price') }}" class="price-field w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500" />
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Laba (Auto)</label>
                                <div class="px-3 py-2 rounded-lg bg-gray-100 border border-gray-200 text-gray-800" id="profit-display">Rp 0</div>
                                <input type="hidden" name="profit" id="profit" value="{{ old('profit',0) }}" />
                            </div>
                ...
                <div class="flex justify-end space-x-4 pt-6 border-t border-gray-200">
                    ...
                    <button type="submit" class="px-6 py-2 rounded-lg bg-blue-600 text-white text-sm font-medium hover:bg-blue-700 shadow">Simpan</button>
                </div>
            </form>
        </div>
    </div>
    ...
    ['purchase_price','sell_price','promo_price'].forEach(id=>{
